...
//            }
    ...
    /*
    // MARK: - CONVERT VIDEO TO .mp4 FORMAT
    var exportSession:AVAssetExportSession!
    func convertVideoAndSaveToParse(videoURL: URL)  {
        ...
        let videoTransform:CGAffineTransform = videoCompositionTrack!.preferredTransform
        ...
        transformer.setTransform(videoAssetTrack.preferredTransform, at: kCMTimeZero)
        transformer.setOpacity(0.0, at: asset.duration)
        
        
        
        //add instruction
        compositionInstruction.layerInstructions = [transformer]
       ...
       // let img = self.canvasView.toImage()
        ...
        textLayer.contents = self.tempImageView.image?.cgImage
        ...
        exportSession!.exportAsynchronously(completionHandler: {() -> Void in
            if let status = exportSession?.status{
                ...
                case .completed:
                    ...
                    let Obj = PFObject(className: CLASS_NAME_STORIES)
                    
                    Obj[CLASS_STORIES_OWNER] = currentUser?.objectId
                    Obj["ownerPointer"] = currentUser
                    Obj[CLASS_STORIES_CAMPUS] =  "rmu"
                    Obj[CLASS_STORIES_VIEWS] = 0
                    Obj[CLASS_STORIES_COMTENT] = "mp4"
                    let hasview = [String]()
                    Obj[CLASS_STORIES_WHOVIEWS] = hasview
                    ...
                    Obj[CLASS_STORIES_SNAP] = videoFile
